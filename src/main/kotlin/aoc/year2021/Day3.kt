...
class Day3Problem() : DailyProblem<Long>() {
    ...
    override fun part1(): Long {
        val input = parseBinaryFile(getInputFile().absolutePath)
    ...
    override fun part2(): Long {
        val oxygen = bitCriteria(this.getInputFile().absolutePath, CountMode.MostCommon)
        val co2 = bitCriteria(this.getInputFile().absolutePath, CountMode.LeastCommon)
